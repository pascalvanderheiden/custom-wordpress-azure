...
#   ./azuredeploy_webapp.sh -r wordpress-rg -s wordpressshared-rg -l westeurope -a wordpress-sp -m wp-mysql-svr -d wp_wordpressdb -w wordpress-wa -c wordpress-cdn -e wordpress
#
...
while getopts r:s:l:a:m:d:w:c:e: option
do
	case "${option}"
	in
